    ...
    buttons.forEach(button => {
        button.addEventListener('click', function() {
            ...
            if (!imgElement.classList.contains('animating')) {
                ...
                const imgSrc = `https://cdn.jsdelivr.net/gh/AnnaLafleur/Florist@main/img/animation/${flowerName}/${colorName}/0001.png`;
            ...
            modalImage.onclick = () => {
                ...
                tempAnimation.sprite = `https://cdn.jsdelivr.net/gh/AnnaLafleur/Florist@main/img/animation/${flowerName}/${currentColor}.png`;
                tempAnimation.firstFrame = `https://cdn.jsdelivr.net/gh/AnnaLafleur/Florist@main/img/animation/${flowerName}/${currentColor}/0001.png`;
            ...
            for (let i = 0; i < iconCount; i++) {
                ...
                iconDiv.addEventListener('click', () => {
                    ...
                    const newImageSrc = `https://cdn.jsdelivr.net/gh/AnnaLafleur/Florist@main/img/animation/${flowerName}/${colorName}/0001.png`;
                    const testImage = new Image();
                    testImage.onload = () => {
                    ...
                    testImage.onerror = () => {
                        modalImage.src = `https://cdn.jsdelivr.net/gh/AnnaLafleur/Florist@main/img/animation/${flowerName}/white/0001.png`;
                        modalImage.style.display = 'block';
