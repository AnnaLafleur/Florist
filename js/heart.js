...
function saveStateToLocalStorage(step) {
    ...
    const stateKey = step === 'step3' || step === 'prints' ? 'gridStateStep3' : 'gridState';
...
function updatePositions(step, excludeIndex = null) {
    ...
    if (!isCreatorPage || step === 'directory' || step === 'step2') {
        ...
        // For step-3 and prints, use styles consistent with paper-or-box.js
