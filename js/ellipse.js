document.addEventListener('DOMContentLoaded', function() {
    ...
    function drawEllipse() {
        ...
        backImg.setAttribute('href', `img/print/box/${backShape}/back.png`);
        if (boxMode) {
    ...
    function initialize() {
        ...
        if (boxRadioEl) boxRadioEl.addEventListener('change', () => setTimeout(drawEllipse, 100));
        if (paperRadioEl) paperRadioEl.addEventListener('change', () => setTimeout(drawEllipse, 100));
